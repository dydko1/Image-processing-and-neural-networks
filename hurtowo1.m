function varargout = hurtowo1(varargin)
% HURTOWO1 M-file for hurtowo1.fig
%      HURTOWO1, by itself, creates a new HURTOWO1 or raises the existing
%      singleton*.
%
%      H = HURTOWO1 returns the handle to a new HURTOWO1 or the handle to
%      the existing singleton*.
%
%      HURTOWO1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in HURTOWO1.M with the given input arguments.
%
%      HURTOWO1('Property','Value',...) creates a new HURTOWO1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before hurtowo1_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to hurtowo1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help hurtowo1
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @hurtowo1_OpeningFcn, ...
    'gui_OutputFcn',  @hurtowo1_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before hurtowo1 is made visible.
function hurtowo1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to hurtowo1 (see VARARGIN)

% Choose default command line output for hurtowo1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes hurtowo1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = hurtowo1_OutputFcn(hObject, eventdata, handles)
...
if (sum(wskazanykataloG)~=0)
    ...
    if (sum(docelowykataloG)~=0)
        ...
        %  a inaczej ja przerobilem w hurtowo1.m
        % 
        % ---------------------------------------------------- %
