function varargout = hurtowo2(varargin)
% HURTOWO2 M-file for hurtowo2.fig
%      HURTOWO2, by itself, creates a new HURTOWO2 or raises the existing
%      singleton*.
%
%      H = HURTOWO2 returns the handle to a new HURTOWO2 or the handle to
%      the existing singleton*.
%
%      HURTOWO2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in HURTOWO2.M with the given input arguments.
%
%      HURTOWO2('Property','Value',...) creates a new HURTOWO2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before hurtowo2_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to hurtowo2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help hurtowo2
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @hurtowo2_OpeningFcn, ...
    'gui_OutputFcn',  @hurtowo2_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before hurtowo2 is made visible.
function hurtowo2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to hurtowo2 (see VARARGIN)

% Choose default command line output for hurtowo2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes hurtowo2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = hurtowo2_OutputFcn(hObject, eventdata, handles)
...
if (sum(wskazanykataloG)~=0)
    ...
    if (sum(docelowykataloG)~=0)
        ...
        %  a inaczej ja przerobilem w hurtowo2.m
        % 
        % ---------------------------------------------------- %
