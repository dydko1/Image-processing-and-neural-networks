...
sprawnosc_01=0;
nnn=[];
while sprawnosc_01 < sprawnoscZalozona
    [Ttest_01,Ytest_01,sprawnosc_01,net_01,tr_01,Itest_01,rozp_01,pop_01,npop_01,nrozp_01,L1,L2]=siecMieszana(0.2,duza,mala,DoTestow,2,3);
...
sprawnosc_02=0;
nnn=[];
while sprawnosc_02 < sprawnoscZalozona
    [Ttest_02,Ytest_02,sprawnosc_02,net_02,tr_02,Itest_02,rozp_02,pop_02,npop_02,nrozp_02,L1,L2]=siecMieszana(0.2,duza,mala,DoTestow,2,3);
